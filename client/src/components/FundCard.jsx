        ...
        <div className='flex flex-col p-4'>
            ...
            <div className='flex justify-between flex-wrap mt-[15px] gap-2'>
                <div className='flex flex-col'>
                    ...
                    <p className='mt-[3px] font-epilogue fonr-normal text-[12px] leading-[18px] text-[#808191] sm:max-w-[120px] truncate'>Raised of {target}</p>
                </div>
                <div className='flex flex-col'>
                    <h4 className='font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]'>{remainingDays}</h4>
                    <p className='mt-[3px] font-epilogue fonr-normal text-[12px] leading-[18px] text-[#808191] sm:max-w-[120px] truncate'>Days Left</p>
                </div>
                </div>
                <div>
